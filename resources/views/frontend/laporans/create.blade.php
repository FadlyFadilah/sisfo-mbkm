        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('frontend.laporans.store') }}" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            <div class="form-group">
                                <label class="required"
                                    for="pengajuan_id">{{ trans('cruds.laporan.fields.pengajuan') }}</label>
                                <select class="form-control select2" name="pengajuan_id" id="pengajuan_id" required>
                                    @foreach ($pengajuans as $id => $entry)
                                        <option value="{{ $id }}"
                                            {{ old('pengajuan_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                <label class="required"
                                    for="sertifikat">{{ trans('cruds.laporan.fields.sertifikat') }}</label>
