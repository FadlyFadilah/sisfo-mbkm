                            ...
                            <tbody>
                                @foreach($pengajuans as $key => $pengajuan)
                                    <tr data-entry-id="{{ $pengajuan->id }}">
                                        ...
                                        <td>
                                            @can('pengajuan_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.pengajuans.show', $pengajuan->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('pengajuan_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.pengajuans.edit', $pengajuan->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('pengajuan_delete')
                                                <form action="{{ route('frontend.pengajuans.destroy', $pengajuan->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('pengajuan_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.pengajuans.massDestroy') }}",
