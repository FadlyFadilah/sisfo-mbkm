        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.mahasiswas.update', [$mahasiswa->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id"
                        ...
                        @foreach ($users as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('user_id') ? old('user_id') : $mahasiswa->user->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                        @endforeach
                    </select>
                    @if ($errors->has('user'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nama_lengkap') ? 'is-invalid' : '' }}" type="text"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nim') ? 'is-invalid' : '' }}" type="text" name="nim"
                        id="nim" value="{{ old('nim', $mahasiswa->nim) }}" required>
                    @if ($errors->has('nim'))
                ...
                <div class="form-group">
                    ...
                    @foreach (App\Models\Mahasiswa::JENIS_KELAMIN_RADIO as $key => $label)
                        <div class="form-check {{ $errors->has('jenis_kelamin') ? 'is-invalid' : '' }}">
                            <input class="form-check-input" type="radio" id="jenis_kelamin_{{ $key }}"
