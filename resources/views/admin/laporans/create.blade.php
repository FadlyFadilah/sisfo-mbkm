        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.laporans.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('pengajuan') ? 'is-invalid' : '' }}"
                        name="pengajuan_id" id="pengajuan_id" required>
                        @foreach ($pengajuans as $id => $entry)
                            <option value="{{ $id }}" {{ old('pengajuan_id') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <div class="needsclick dropzone {{ $errors->has('sertifikat') ? 'is-invalid' : '' }}"
                ...
                <div class="form-group">
                    ...
                    <div class="needsclick dropzone {{ $errors->has('laporan') ? 'is-invalid' : '' }}"
                        id="laporan-dropzone">
                    </div>
